...
class KeyDBClusterException(Exception):
    """
    Base exception for the KeyDBCluster client
    """

    pass


class ClusterError(KeyDBError):
    """
...
class SlotNotCoveredError(KeyDBClusterException):
    """
