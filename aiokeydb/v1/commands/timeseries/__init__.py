...
from aiokeydb.v1.commands.helpers import parse_to_list
from aiokeydb.v1.commands.timeseries.commands import (
    ALTER_CMD,
    CREATE_CMD,
    CREATERULE_CMD,
    DEL_CMD,
...
from aiokeydb.v1.commands.timeseries.info import TSInfo
from aiokeydb.v1.commands.timeseries.utils import parse_get, parse_m_get, parse_m_range, parse_range
...
class TimeSeries(TimeSeriesCommands):
    ...
    def __init__(self, client=None, **kwargs):
        ...
        self.MODULE_CALLBACKS = {
            CREATE_CMD: aiokeydb.v1.client.bool_ok,
            ALTER_CMD: aiokeydb.v1.client.bool_ok,
            CREATERULE_CMD: aiokeydb.v1.client.bool_ok,
            DEL_CMD: int,
            DELETERULE_CMD: aiokeydb.v1.client.bool_ok,
    ...
    def pipeline(self, transaction=True, shard_hint=None):
        ...
        """
        if isinstance(self.client, aiokeydb.v1.KeyDBCluster):
            p = ClusterPipeline(
...
class ClusterPipeline(TimeSeriesCommands, aiokeydb.v1.cluster.ClusterPipeline):
    """Cluster pipeline for the module."""


class Pipeline(TimeSeriesCommands, aiokeydb.v1.client.Pipeline):
