...
from aiokeydb.v1.asyncio.core import AsyncPipeline
from aiokeydb.v1.commands.search.commands import AsyncSearchCommands, SearchCommands
...
class Pipeline(SearchCommands, aiokeydb.v1.client.Pipeline):
    """Pipeline for the module."""


class AsyncPipeline(AsyncSearchCommands, AsyncPipeline):
