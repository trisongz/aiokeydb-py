...
from aiokeydb.v1.core import Pipeline

from aiokeydb.v1.commands.helpers import parse_to_dict
from aiokeydb.v1.commands.search._util import to_string
from aiokeydb.v1.commands.search.aggregation import AggregateRequest, AggregateResult, Cursor
from aiokeydb.v1.commands.search.document import Document
from aiokeydb.v1.commands.search.query import Query
from aiokeydb.v1.commands.search.result import Result
from aiokeydb.v1.commands.search.suggestion import SuggestionParser
...
class SearchCommands:
    ...
    def create_index(
        ...
        args.append("SCHEMA")
        try:
            args += list(itertools.chain(*(f.keydb_args() for f in fields)))
        except TypeError:
            args += fields.keydb_args()
