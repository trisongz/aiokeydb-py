...
from aiokeydb.v1.commands.json.commands import JSONCommands
from aiokeydb.v1.commands.json.decoders import bulk_of_jsons, decode_list
...
class ClusterPipeline(JSONCommands, aiokeydb.v1.cluster.ClusterPipeline):
    """Cluster pipeline for the module."""


class Pipeline(JSONCommands, aiokeydb.v1.client.Pipeline):
