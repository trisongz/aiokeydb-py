...
from aiokeydb.v1.utils import CRYPTOGRAPHY_AVAILABLE, HIREDIS_AVAILABLE, HIREDIS_PACK_AVAILABLE, str_if_bytes, set_ulimits
...
class SocketBuffer:
    ...
    def _read_from_socket(
        ...
        timeout: typing.Union[float, object] = SENTINEL,
        raise_on_timeout: typing.Optional[bool] = True,
    ) -> bool:
        sock = self._sock
...
class Connection:
    ...
    def set_parser(self, parser_class):
        ...
        """
        self._parser: typing.Type[BaseParser] = parser_class(socket_read_size=self._socket_read_size)
...
class SSLConnection(Connection):
    ...
    def _connect(self):
        ...
        if self.ssl_validate_ocsp_stapled:
            import OpenSSL
            from aiokeydb.v1.ocsp import ocsp_staple_verifier
        ...
        if self.ssl_validate_ocsp is True and CRYPTOGRAPHY_AVAILABLE:
            from aiokeydb.v1.ocsp import OCSPVerifier
