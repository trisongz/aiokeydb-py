...
from aiokeydb.v1.compat import Protocol

if TYPE_CHECKING:
    from aiokeydb.v1.asyncio.connection import AsyncConnectionPool
    from aiokeydb.v1.asyncio.connection import Encoder as AsyncEncoder
    from aiokeydb.v1.connection import ConnectionPool, Encoder
