...
class Lock:
    """
    A shared, distributed Lock. Using KeyDB for locking allows the Lock
    ...
    def __init__(
        ...
        """
        Create a new Lock instance named ``name`` using the KeyDB client
        supplied by ``keydb``.
    ...
    async def acquire(
        ...
        """
        Use KeyDB to hold a shared, distributed lock named ``name``.
