...
# from aiokeydb.configs import settings as get_keydb_settings()
from aiokeydb.types.jobs import Job, CronJob, JobStatus, TaskType
...
from aiokeydb.utils.logs import logger, ColorMap
...
class Worker:
    ...
    def from_settings(
        ...
        **kwargs
        ...
        """
        verbose = verbose or get_keydb_settings().worker.debug_enabled
    ...
    def add_context(
        ...
        **kwargs,
        ...
        """
        return get_keydb_settings().worker.add_context(
            obj = obj, 
            name = name, 
            verbose = verbose, 
            silenced = silenced, 
    ...
    def add_dependency(
        ...
        **kwargs,
        ...
        Args:
            ...
            kwargs: additional arguments to pass to the function
        """
        return get_keydb_settings().worker.add_dependency(
            obj = obj, 
            name = name, 
            verbose = verbose, 
            silenced = silenced, 
    ...
    def on_startup(
        ...
        **kwargs,
        ...
        """
        return get_keydb_settings().worker.on_startup(
            name = name, 
            verbose = verbose, 
            _fx = _fx, 
            silenced = silenced, 
    ...
    def on_shutdown(
        ...
        **kwargs,
        ...
        """
        return get_keydb_settings().worker.on_shutdown(
            name = name, 
            verbose = verbose, 
            _fx = _fx, 
            silenced = silenced, 
    ...
    def add_function(
        ...
        **kwargs,
        ...
        """
        return get_keydb_settings().worker.add_function(
            name = name, 
            _fx = _fx, 
            verbose = verbose, 
            silenced = silenced, 
    ...
    def add_function_to_silenced(
        ...
        **kwargs
        ...
        """
        get_keydb_settings().worker.add_function_to_silenced(name = name, silenced_stages = silenced_stages, **kwargs)
    ...
    def add_cronjob(        
        ...
        **kwargs,
        ...
        """
        return get_keydb_settings().worker.add_cronjob(
            schedule = schedule, 
            _fx = _fx, 
            verbose = verbose, 
            silenced = silenced, 
    ...
    def add(
        ...
        **kwargs,
        ...
        Args:
            ...
            kwargs: additional arguments to pass to the function
        """
        return get_keydb_settings().worker.add(
            task = task, 
            name = name, 
            obj = obj, 
            verbose = verbose, 
    ...
    def set_queue_func(
        ...
        """
        return get_keydb_settings().worker.set_queue_func(queue_func = queue_func)
    ...
    def add_fallback_function(
        ...
        **IMPORTANT**: The function must be a coroutine function, and
        ...
        >>     return "Hello World"
        """
        return get_keydb_settings().worker.add_fallback_function(
            verbose = verbose, 
            silenced = silenced, 
            method = method, 
            timeout = timeout,
