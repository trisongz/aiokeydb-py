...
from aiokeydb.types.static import JobStatus, TaskType, TERMINAL_STATUSES, UNSUCCESSFUL_TERMINAL_STATUSES, INCOMPLETE_STATUSES
from aiokeydb.utils.lazy import (
    get_default_job_timeout,
    get_default_job_retries,
    get_default_job_ttl,
    get_default_job_retry_delay,
)
...
class CronJob(BaseModel):
    ...
    timeout: typing.Optional[int] = Field(default_factory = get_default_job_timeout)
    retries: typing.Optional[int] = Field(default_factory = get_default_job_retries)
    ttl: typing.Optional[int] = Field(default_factory = get_default_job_ttl)
...
class Job(BaseModel):
    ...
    retries: typing.Optional[int] = Field(default_factory = get_default_job_retries)
    ttl: typing.Optional[int] = Field(default_factory = get_default_job_ttl)
    retry_delay: typing.Optional[float] = Field(default_factory = get_default_job_retry_delay)
