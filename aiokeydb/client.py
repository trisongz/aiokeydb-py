...
from aiokeydb.typing import Number, KeyT, AbsExpiryT, ExpiryT, PatternT
from aiokeydb.configs import KeyDBSettings, KeyDBWorkerSettings
# , settings as default_settings
from aiokeydb.types import KeyDBUri
...
class KeyDBClientMeta(type):
    ...
    _settings: typing.Optional[KeyDBSettings] = None
    ...
    def settings(cls) -> KeyDBSettings:
        """
        Lazy loads the settings
        """
        if cls._settings is None:
            cls._settings = get_keydb_settings()
        return cls._settings

    def get_settings(cls, **kwargs) -> KeyDBSettings:
        """
