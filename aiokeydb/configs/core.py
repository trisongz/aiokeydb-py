...
from aiokeydb.types import BaseSettings, validator, root_validator, lazyproperty, KeyDBUri
from aiokeydb.serializers import SerializerType, BaseSerializer
from aiokeydb.utils import import_string
        ...
        if self.async_pool_class and _is_async:
            if isinstance(self.async_pool_class, str):
                if 'blocking' in self.async_pool_class.lower():
                    from aiokeydb.connection import AsyncBlockingConnectionPool
                    return AsyncBlockingConnectionPool
                from aiokeydb.connection import AsyncConnectionPool
            ...
            if isinstance(self.pool_class, str):
                if 'blocking' in self.pool_class.lower():
                    from aiokeydb.connection import BlockingConnectionPool
                    return BlockingConnectionPool
                from aiokeydb.connection import ConnectionPool
