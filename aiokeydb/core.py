...
class KeyDB(AbstractKeyDB, RedisModuleCommands, CoreCommands, SentinelCommands):
    """
    ...
    def __init__(
        ...
        if single_connection_client: self.connection = self.connection_pool.get_connection("_")
...
class Pipeline(KeyDB):
    ...
    def parse_response(self, connection, command_name, **options):
        result = KeyDB.parse_response(self, connection, command_name, **options)
