...
from aiokeydb.connection import Connection, ConnectionPool, EncodableT, SSLConnection
...
class Sentinel:
    ...
    >>> from aiokeydb.sentinel import Sentinel
    ...
    def master_for(
        self,
        service_name: str,
        keydb_class: Type[KeyDB] = KeyDB,
        connection_pool_class: Type[SentinelConnectionPool] = SentinelConnectionPool,
        **kwargs,
    ):
        """
        Returns a keydb client instance for the ``service_name`` master.

        A :py:class:`~keydb.sentinel.SentinelConnectionPool` class is
        ...
        By default clients will be a :py:class:`~keydb.KeyDB` instance.
        Specify a different class to the ``keydb_class`` argument if you
        desire something different.

        The ``connection_pool_class`` specifies the connection pool to
        use.  The :py:class:`~keydb.sentinel.SentinelConnectionPool`
    ...
    def slave_for(
        ...
        **kwargs,
        ...
        """
        Returns keydb client instance for the ``service_name`` slave(s).
