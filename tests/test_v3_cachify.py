...
from aiokeydb.queues import Worker, TaskQueue
from aiokeydb.client import logger

session = KeyDBClient.init_session()

@session.cachify_v2(ttl=10)
...
@session.cachify_v2(cache_ttl=10)
